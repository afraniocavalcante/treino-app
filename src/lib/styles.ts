...
export const styles: Record<string, CSSProperties> = {
  ...
  sheet: { margin: "0 14px 14px", padding: "30px 26px 26px", background: "rgba(22,22,20,.92)", border: "1px solid rgba(13,27,42,.1)", borderRadius: 30, backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", boxShadow: "0 30px 70px -30px rgba(0,0,0,.95)", animation: `tabFadeUp .4s ${EASE} both`, width: "100%" }, // NOVO
